...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($StoreName)) {
        ...
        $errors[] = "Store name is not allowed, Enter valid brand name.";
    }
    ...
    if (!empty($errors)) {
        ...
        $sql = "UPDATE Stores SET StoreName='$StoreName', StoreAddress='$StoreAddress', StoreCity='$StoreCity' WHERE StoreID='$id'";
        ...
        <div class="col-md-6">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="StoreName" name="StoreName" placeholder="Puma" value="<?php echo $StoreName ?>">
                </div>
                <div class="form-group">
                    <label for="desc">Brand Description:</label>
                    <input type="text" class="form-control" id="StoreAddress" name="StoreAddress" placeholder="Sportswear Brand" value="<?php echo $StoreAddress ?>">
                </div>
                <div class="form-group">
                    <label for="Category">Brand Category:</label>
                    <input type="text" class="form-control" id="StoreCity" name="StoreCity" placeholder="Fashion" value="<?php echo $StoreCity ?>">
                </div>
